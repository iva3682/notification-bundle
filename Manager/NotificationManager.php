...
class NotificationManager
{
    ...
    public function __construct(Container $container, NotifiableDiscovery $discovery)
    {
        ...
        $this->notifiableRepository = $this->om->getRepository('Mgilet\NotificationBundle\Entity\NotifiableEntity');
        $this->notificationRepository = $this->om->getRepository('Mgilet\NotificationBundle\Entity\Notification');
        $this->notifiableNotificationRepository = $this->om->getRepository('Mgilet\NotificationBundle\Entity\NotifiableNotification');
    }
